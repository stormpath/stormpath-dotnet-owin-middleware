...
#line hidden
    ...
    {
#line 4 "ForgotPassword.cshtml"

    private Stormpath.Owin.Common.ViewModel.ForgotPasswordViewModel Model { get; }
...
.btn-sp-green:focus {
  ...
  -ms-fi");
            WriteLiteral(@"lter: ""progid:DXImageTransform.Microsoft.gradient (GradientType=0, startColorstr=#2ec700, endColorstr=#43cd1a)"";
}
...
.btn-facebook:focus {
  ...
  -ms-filter: ""progid:DXImageTransform.M");
            WriteLiteral(@"icrosoft.gradient (GradientType=0, startColorstr=#3767db, endColorstr=#4773de)"";
}
...
.btn-linkedin {
  ...
  background: linear-gradient(#007cbc 50%, #0077B5");
            WriteLiteral(@" 50%);
...
.btn-github {
  ...
  -ms-filter: ""progid:DXImageTransform.Microsoft.gradient (GradientType=0, startColorstr=#848");
            WriteLiteral(@"282, endColorstr=#7B7979)"";
}
...
.sp-form .ha");
            WriteLiteral(@"s-error input[type=""text""],
...
.login-view .email-password-area input[type='checkbox']:checked + label:after {
  background: url(data:image/png;base64,");
            WriteLiteral(@"");
            WriteLiteral(@"OJzoQ//37t5eLi2sRMMDec3Jypn79+lVXX1//H9HRaGJisvr379/nuLm5lwKdP9vMzOwZyekAaEA3EF8G4hZCYcQ4mhcYAAIMAJGST/dDIpNQAAAAAElFTkSuQmCC);
...
");
#line 420 "ForgotPassword.cshtml"
...
");
#line 430 "ForgotPassword.cshtml"
                }
...
");
#line 444 "ForgotPassword.cshtml"
...
#line 447 "ForgotPassword.cshtml"
...
#line hidden
            ...
            WriteLiteral("                                    <p>");
#line 449 "ForgotPassword.cshtml"
                                  Write(error);

#line default
#line hidden
            WriteLiteral("</p>\r\n");
#line 450 "ForgotPassword.cshtml"
                                }
...
#line hidden
            ...
            WriteLiteral("                            </div>\r\n");
#line 452 "ForgotPassword.cshtml"
                        }
...
#line hidden
            ...
            BeginWriteAttribute("action", " action=\"", 14059, "\"", 14092, 1);
#line 454 "ForgotPassword.cshtml"
WriteAttributeValue("", 14068, Model.ForgotPasswordUri, 14068, 24, false);
...
");
#line 468 "ForgotPassword.cshtml"
...
#line hidden
            ...
            WriteLiteral("                    <a");
            BeginWriteAttribute("href", " href=\"", 14943, "\"", 14965, 1);
#line 470 "ForgotPassword.cshtml"
WriteAttributeValue("", 14950, Model.LoginUri, 14950, 15, false);

#line default
#line hidden
            EndWriteAttribute();
            WriteLiteral(" class=\"forgot\">Back to Log In</a>\r\n");
#line 471 "ForgotPassword.cshtml"
                }
