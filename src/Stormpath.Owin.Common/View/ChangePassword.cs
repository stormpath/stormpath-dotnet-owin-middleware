...
<head>
    ...
    ");
        ...
        .btn-sp-green {
            ...
            -ms-f");
            WriteLiteral(@"ilter: ""progid:DXImageTransform.Microsoft.gradient (GradientType=0, startColorstr=#2dbd00, endColorstr=#42c41a)"";
        }
        ...
        .btn-facebook {
            ...
            WriteLiteral(@"radient(#4c6fc5 50%, #3d63c0 50%);
        ...
        .btn-google {
            ...
            backgr");
            WriteLiteral(@"ound: linear-gradient(#e05b4b 50%, #dd4b39 50%);
      ...
      ");
            WriteLiteral(@"      filter: progid:DXImageTransform.Microsoft.gradient(GradientType=0, startColorstr=#007cbc, endColorstr=#0077B5);
        ...
        .btn-github {
            ...
            WriteLiteral(@"nt(GradientType=0, startColorstr=#848282, endColorstr=#7B7979);
        ...
        .form-control {
            ...
            ");
            WriteLiteral(@".form-control::-moz-placeholder {
                color: #aaadb0;
            }
        ...
        .sp-form .has-error .help-block {
            ...
            .sp-form .has-er");
            WriteLiteral(@"ror input[type=""text""],
        ...
        .");
            WriteLiteral(@"login-view .header p {
            margin-top: 2em;
        }
        ...
        .login-view .email-password-area input[type='checkbox'] {
            ...
            .login-view .email-password-area input[type='checkbox']:checked + label:after {
                background: url(data:image/png;base64,");
            WriteLiteral(@");
                background-position: -1px -1px;
            }

        @media (min-width: 767px) {
            .log");
            WriteLiteral(@"in-view .email-password-area.small {
...
");
#line 438 "ChangePassword.cshtml"
...
#line 441 "ChangePassword.cshtml"
...
#line hidden
            ...
            WriteLiteral("                                    <p>");
#line 443 "ChangePassword.cshtml"
                                  Write(error);

#line default
#line hidden
            WriteLiteral("</p>\r\n");
#line 444 "ChangePassword.cshtml"
                                }
...
#line hidden
            ...
            WriteLiteral("                            </div>\r\n");
#line 446 "ChangePassword.cshtml"
                        }
